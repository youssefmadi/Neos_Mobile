...
mainMenu.push({id:"7",title:"Live Tv",icon:"icon-television",order:1,enabled:true});
mainMenu.push({id:"8",title:"World Radio",icon:"icon-television",order:8,enabled:false});
mainMenu.push({id:"9",title:"View Bill",icon:"icon-television",order:9,enabled:false});
mainMenu.push({id:"10",title:"Languages",icon:"icon-television",order:10,enabled:false});
